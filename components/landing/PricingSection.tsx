      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <span className="text-[#b5924c] flex-shrink-0">✓</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#b5924c] flex-shrink-0">✓</span>
                  <span className="text-[#1c1a17] text-sm">Email support</span>
                </li>
              </ul>
            </div>
            <Link href="/login" className="btn-outline w-full text-center mt-6">
              Get Started Free
            </Link>
          </div>

          {/* Pro Tier */}
          <div className="card p-8 h-full flex flex-col border-2 border-[#b5924c] relative">
            ...
            <Link href="/login" className="btn-gold w-full text-center mt-6">
              Start Pro
            </Link>
          </div>
          ...
          <div className="card p-8 h-full flex flex-col">
            ...
            <Link href="mailto:contact@karrar.ai" className="btn-outline w-full text-center mt-6">
              Contact Us
            </Link>
          </div>
        </div>
